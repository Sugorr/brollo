            ...
            <div id="Sidebar-Section">
                ...
                <div className="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" 
                    ...
                    <div className="offcanvas-header">
                        ...
                        <div className="SideBar-Blue-B">B</div>
                        <div className="SideBar-Rollo">rollo</div>
                        </h5>
                        <button type="button" className="SideBar-Close-Button btn-close" data-bs-dismiss="offcanvas" 
